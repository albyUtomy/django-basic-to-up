...
#         print(student)
    ...
    # Replace these with actual objects or valid IDs from your database
    teacher = Teacher.objects.first()
    school = School.objects.first()
    department = Department.objects.first()

    student = Student_Progress.objects.create(
        name="Test Student",
        chemistry_mark=85.0,
        physics_mark=90.0,
        maths_mark=95.0,
    ...
    print(student.gained_mark)   # Should be the sum of marks
    print(student.percentage)    # Should be calculated
    print(student.out_off)       # Should be 300 or your defined default
